 ...
 * Description: A contact 7 add-on that allows a contact form to send and receive an SMS text. Reply to a text in an online text dashboard or mobile phone using the Biz Text service. 
 * Version: 3.1
 * Author: Biz Text
